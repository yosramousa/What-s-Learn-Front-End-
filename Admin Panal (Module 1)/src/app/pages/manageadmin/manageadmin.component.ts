...
levename :string;
  ...
  constructor( private dialog: MatDialog ,location:Location, private renderer : Renderer2, private element : ElementRef,private router: Router, private manageAdminService: ManageAdminService) { 
